...
A crucial distinction for understanding the structure of an STR market is the distinction between casual STRs (“home-sharing”) and dedicated STRs (“commercial operations”). One way to capture this distinction is to examine the distribution of revenue among STR hosts. Is revenue widely distributed between many part-time hosts of single listings, or concentrated among a small number of commercial operators who control many full-time listings?

While hosts are identified on Airbnb or VRBO with unique accounts, these accounts are not necessarily an accurate guide to the individuals or companies which operate STR listings, since a given person or group of people can create as many host accounts as they wish, and split their listings among these accounts. What may appear superficially as a large number of small STR operators could thus be in reality a much smaller number of operators controlling many accounts each. To address this possibility, we use image recognition software to identify photographs which are used across multiple listings, and thereby construct groups of host accounts which are either a single operator or a network of operators working in collaboration.

We identified one network of hosts whose 580 listings earned approximately $4.1 million in 2019. An investigation into a sample of the host accounts which make up this network suggests links between numerous property management companies and third party operators. Through time, several individual host accounts seem to have merged into a cluster of larger hosts. The image-matching algorithm also merged hosts that use both Airbnb and VRBO, allowing for more accurate revenue calculations. Without interviewing actors associated with this host network, it is impossible to describe the level of connection and coordination between the various host accounts, but an operation of this scale would not be unprecedented. Reports from Chicago, USA and London, UK have identified similar host networks behind which were property management companies and realty groups (Conti, 2019). 

Among all the STR hosts who earned revenue in the City of Vancouver last year, the median revenue was $15,700, while the top host network earned roughly $4.1 million (Table 1.6.1). Throughout the City of Vancouver, there were 27 hosts that earned more than $250,000 in 2019. Figure 1.6.1 shows the percentage of the total $151.8 million in STR revenue which accrued to each decile of hosts. x The revenue concentration is even steeper among the top 10%: the top 5% earned 30.5% of revenue, while the top 1% of hosts earned 13.6% of all revenue. 

There is a high degree of STR revenue concentration among hosts, which indicates a market dominated by a small number of larger-scale commercial operators. However, Vancouver’s STR market is less commercialized than other major Canadian cities (As source of comparison, Montreal’s top 10% earned 68.8% of all revenue in 2019.).
...
We consider entire-homes to be multilistings if they are operated by hosts who are simultaneously operating other entire-home listings. We define private-room multilistings as cases where a host has three or more private-room listings operating on the same day. Since 94.0% of entire-home listings have three or fewer bedrooms, there will be extremely few cases where a host operating three private-room STR listings in a dwelling unit has not converted the entire unit into a dedicated STR. 

In 2019, 34.6% of active listings in Vancouver were multilistings, earning 30.3% of total host revenue. Multilistings had been growing steadily since 2017, both in terms of listings and revenue percentage, until Airbnb’s mass removal of listings without licence numbers. Since then, the proportion of multilistings and their share of overall revenue has been decreasing. The percentage of multilistings reached an all-time high right after the passing of the regulation in April, which could indicate that the steep decline in listings on STR platforms was caused mainly by operators with single listings that did not intend to acquire a permit to pursue their STR operations, causing the multilistings percentage to inflate. Figure 1.7.1 also highlights that amidst the generally declining STR activity during the COVID-19 pandemic, multilistings earned a bit more than 1 out of every 4 dollars on STR platforms in Vancouver. Intuitively, multilistings that are still operating since April 2018 are in great majority non-compliant to the City’s regulation. It is impossible for a host holding five listings to be operating them all out of its principal residence, which is one of the regulation’s requirements. Multilistings are thus one indicator of the level of non-compliance of STR hosts.

These figures should be taken as highly conservative estimates. Many commercial operators will use different Airbnb or VRBO accounts to manage their listings, making it difficult to determine whether two accounts belong to the same person. Moreover, many STR commercial operators only operate a single listing, but operate it on a full-time basis. A house owner with a secondary suite, or the owner of an investment condo who operates a STR in it, are clearly commercial operators running listings which are not their principal residences, but they would not be counted by this method.

In fact, when multilistings and listings which are operated frequently throughout the year (discussed in more detail in the next section) are aggregated, they dramatically outnumber casual, “home sharing” STRs. The ongoing relative increase in the commercial share of Vancouver’s STR market, when combined with the fact that the total number of active listings in Vancouver has been varying seasonally but remained overall similar leads to a striking conclusion: the number of actual “home sharing” STRs in Vancouver—part-time STRs located in a host’s principal residence—has been plummeting in both relative and absolute terms.

The regulation of 2018 led to a decrease of both non-commercial and commercial listings, but the impact looks more seasonal than durable (explained in detail in the next section), taking in account that non-commercial listings have been declining since the beginning of 2018 and have never reached pre-2018 levels again. A decrease in both relative and absolute numbers of non-commercial listings is a phenomenon observable in other Canadian cities (Montreal), where the market is experiencing increasing commercialization. In Vancouver, the peak in the number of commercial listings in 2018 was 2,920 in August, and this figure was surpassed a little over a year later at 3,040 in January 2020.

Beginning in 2017, every single year has seen fewer “home sharing” STRs operated in Vancouver than the previous year. Previous research has demonstrated that larger STR commercial operations use their economies of scale to lower STR prices and drive casual operators out of the market (Deboosere et al. 2019). The trajectory of Vancouver’s STR market offers a clear example of this pattern.
