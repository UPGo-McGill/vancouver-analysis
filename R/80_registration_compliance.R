...
pull(filter(active_licences, date == "2019-12-31"))-
  pull(filter(active_licences, date == "2019-10-01"))
...
pull(filter(active_licences, date == max(date)))-
  pull(filter(active_licences, date == key_date_covid))
